...
import com.example.proyectofinal_alberto_rodriguezperez.DAO.LibroDAO;
...
public class LibroService {
    ...
    private Retrofit getRetrofit() {
        return new Retrofit.Builder()
                //Por lo visto 10.0.2.2 es una ip que usa android studio para comunicarse con localhost para no tener que cambiarla
